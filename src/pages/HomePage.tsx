      ...
      <div className='homePage__container'>
        <div className='homePage_content'>
          <img 
            ...
            src={FotoProfilo} 
            alt="Foto di Alessandro Uva, sviluppatore web" 
            role="img" 
            aria-label="Foto di Alessandro Uva, sviluppatore web" 
          />
          <div className="homePage__text">
            ...
            <table className="personal-info" aria-labelledby="personal-info-table">
              <tbody>
                <tr>
            ...
            <Accordion 
              ...
              content={
                <>
                  <p><strong>Pregi:</strong> Sono una persona <strong>empatica</strong> e <strong>allegra</strong>, sempre pronta a far sorridere gli altri con una battuta. Rifletto molto e mantengo una <strong>tranquillità</strong> che mi aiuta ad affrontare le sfide con calma. Sono <strong>amichevole</strong> e <strong>dolce</strong>, sempre pronto ad <strong>aiutare gli altri</strong> e a offrire un supporto sincero. Inoltre, sono <strong>preciso</strong> nel mio lavoro e nelle relazioni personali.</p>
                  <p><strong>Difetti:</strong> A volte posso sembrare <strong>poco comunicativo</strong> o <strong>troppo serio</strong>, ma questo dipende dal mio modo di riflettere. A volte mi capita di essere <strong>poco puntuale</strong>, ma sto cercando di migliorare. Infine, sono molto <strong>testardo</strong>, il che può sembrare un difetto, ma mi aiuta a non arrendermi facilmente.</p>
                </>
              }
            />
          </div>
