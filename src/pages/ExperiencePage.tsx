...
const ExperiencePage: React.FC = () => {
  return (
    <div className="Container-App">
      ...
      <main className="experiencePage__content">
        <section aria-labelledby="full-stack-developer">
          <h2 id="full-stack-developer">Full Stack Developer</h2>
          <p>
            <strong>Camillo s.r.l.</strong> | Marzo 2024 – Attualmente
          </p>
          <p>
            A Marzo 2024 sono stato assunto come full stack specializzato nello sviluppo di soluzioni digitali personalizzate per il settore ristorativo...
          </p>
          <h3>Di cosa mi occupavo:</h3>
        ...
        <section aria-labelledby="frontend-developer">
          <h2 id="frontend-developer">Frontend Developer</h2>
          <p>
            <strong>Alpenite</strong> | Giugno 2022 – Novembre 2023
          </p>
          <p>
            A Giugno 2022 ho intrapreso il percorso da Frontend Developer in Alpenite...
          </p>
          <h3>Di cosa mi occupavo:</h3>
          <ul className="list-i-do">
        ...
        <section aria-labelledby="office-manager">
          <h2 id="office-manager">Office Manager</h2>
          <p>
            <strong>Intesa SanPaolo Vita</strong> | Settembre 2017 – Novembre 2021
          </p>
          <ul className="list-i-do">
        ...
        <section aria-labelledby="store-manager">
          <h2 id="store-manager">Store Manager</h2>
          <p>
            <strong>Tiger Italia</strong> | Settembre 2012 – Giugno 2017
          </p>
          <ul className="list-i-do">
            <li>Gestione orari pulizie ufficio</li>
            <li>Gestione turni ufficio</li>
